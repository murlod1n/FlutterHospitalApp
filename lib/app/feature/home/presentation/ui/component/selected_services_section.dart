                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: FilledButton(
                                  onPressed: () => <void>{
                                    context.read<ServiceBloc>().add(GetServiceList(doctorKod: recordState.doctor!.kod)),
                        ...
                        children: <Widget>[
                          SizedBox(
                            ...
                            child: OutlinedButton(
                              ...
                              onPressed: () => context.read<HomeBloc>().add(StepToSelectService(step: 0)),
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton(
                              onPressed: () => context.read<HomeBloc>().add(StepToSelectDate(step: 2)),
  ...
  Widget _emptyListCard(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        boxShadow:
          const <BoxShadow>[BoxShadow(color: Color(0x63D6DBE1), blurRadius: 40)],
